(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AdminPageComponent = /** @class */ (function () {
                function AdminPageComponent(storageService) {
                ...
                AdminPageComponent.prototype.onFileSelect = function (event) {
                    this.selectedImages = [];
                ...
                AdminPageComponent.prototype.sendImages = function () {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GalleryComponent = /** @class */ (function () {
                ...
                GalleryComponent.prototype.pullImageNames = function () {
                    var _this = this;
                    this.storageService.pullImageNames()
                        .valueChanges()
                        .subscribe(function (pulledImageNames) {
                        pulledImageNames.forEach(function (imageName) {
                            _this.imageNames.push(imageName);
                        });
                        _this.imageNames.forEach(function (imgName) {
                            _this.pullImageRefs(imgName);
                        });
                    });
                };
                GalleryComponent.prototype.pullImageRefs = function (imageName) {
                    var _this = this;
                ...
                GalleryComponent.prototype.pushImages = function () {
                    this.imageArr.push({
                        src: this.image1,
                        alt: "Skull boi",
                        title: "I dunno"
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StorageService = /** @class */ (function () {
                ...
                StorageService.prototype.pullImageNames = function () {
                    var path = "/imageNames";
