...
let AddImagesComponent = class AddImagesComponent {
    ...
    onFileSelect(event) {
        ...
        const imageFiles = event.target.files; // Pull file array from event object
...
AddImagesComponent.ctorParameters = () => [
...
let MoveImagesComponent = class MoveImagesComponent {
    constructor(storageService) {
        this.storageService = storageService;
    ...
    pullImageMetadata() {
        ...
        this.storageService
            .pullImageMetadata()
            .valueChanges()
            .subscribe((pulledImageMetadata) => {
            pulledImageMetadata.forEach((imageData) => {
...
MoveImagesComponent.ctorParameters = () => [
    { type: src_app_services_storage_service__WEBPACK_IMPORTED_MODULE_2__["StorageService"] }
];
...
let GalleryComponent = class GalleryComponent {
    ...
    pullImageMetadata() {
        ...
        this.storageService.pullImageMetadata()
            ...
            this.imageMetadata.forEach((imgData) => {
...
let StorageService = class StorageService {
    ...
    changeImageIndexes(imageMetadata) {
